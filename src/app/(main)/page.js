  ...
  return (
    <main className="flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row w-[600px] lg:w-[1100px] self-center text-center">
        <p className="text-primary-950 text-8xl">*</p>
        <h1 className="text-2xl md:text-5xl xl:text-7xl font-black uppercase mx-auto text-primary-950">
          Effortless invoice management from warehouse to customer
        </h1>
        <p className="text-primary text-8xl md:self-end">*</p>
      </div>
      <div className="flex flex-col md:flex-row gap-8 self-center">
        {attrArr.map((att) => (
          <div
            key={att}
            className="flex item-center gap-3 text-primary font-semibold"
          >
      ...
      <div className="flex flex-col items-center justify-center mt-6 gap-4">
        ...
        <div className="bg-primary px-6 py-4 flex gap-4 rounded-full md:absolute md:right-[-20px] md:rotate-[-20deg] font-bold">
          <p className="text-white">Have questions?</p>
        </div>
        <div className="bg-primary px-12 py-4 flex rounded-full md:absolute md:left-[-40px] font-bold md:bottom-12">
      ...
      <Button
        ...
        size="large"
        href="/signup"
        className="bg-primary  rounded-full self-center text-xl animate-bounce"
      >
        Get Started
      </Button>
    </main>
